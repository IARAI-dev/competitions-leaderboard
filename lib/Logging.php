...
class Logging {
	...
	public function register_taxonomy() {
		...
		register_taxonomy( 'wp_log_type', 'wp_log', $args );
	...
	public static function add( $title = '', $message = '', $parent = 0, $type = null, $extra = [] ) {
		...
		if ( isset( $extra['post_date'] ) ) {
			$log_data['post_date'] = $extra['post_date'];
		}
		if ( isset( $extra['post_date_gmt'] ) ) {
			$log_data['post_date_gmt'] = $extra['post_date_gmt'];
		}
